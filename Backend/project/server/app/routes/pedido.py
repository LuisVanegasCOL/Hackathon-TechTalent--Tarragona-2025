...
from project.server.app.controllers.pedido import (
    ...
    delete_pedido_controller, get_pedido_by_id_controller, get_pedidos_by_user_controller
)
...
@pedido_bp.route('/usuario/<int:user_id>', methods=['GET', 'OPTIONS'])
def get_pedidos_by_user(user_id):
    ...
    return get_pedidos_by_user_controller(user_id)
