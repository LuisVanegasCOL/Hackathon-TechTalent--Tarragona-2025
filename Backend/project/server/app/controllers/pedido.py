...
from project.server.app.services.pedido import (
    ...
    delete_pedido_service, get_pedido_by_id_service, get_pedidos_by_user_service
)
...
def get_pedidos_by_user_controller(user_id):
    """Obtener pedidos de un usuario específico"""
    try:
        result = get_pedidos_by_user_service(user_id)
